    ...
    const filterAndSortSessions = () => {
        ...
        if (searchTerm) {
            filtered = filtered.filter(session =>
                session.formationTitre?.toLowerCase().includes(searchTerm.toLowerCase()) ||
                session.entrepriseNom?.toLowerCase().includes(searchTerm.toLowerCase())
            );
        }
        ...
        <div className="container-fluid">
            <div className="row mb-4">
                <div className="col-12">
                    ...
                    <p className="text-muted">Liste de toutes vos sessions de formation</p>
                </div>
            </div>
                        ...
                        <div className="col-md-6">
                            <div className="input-group">
                                ...
                                <input
                                    ...
                                    placeholder="Rechercher une formation ou entreprise..."
                                    value={searchTerm}
                    ...
                    <div className="table-responsive">
                        <table className="table table-hover mb-0">
                            <thead className="table-light">
                                <tr>
                                    <th className="border-0 py-3 px-4" style={{ cursor: 'pointer' }} onClick={() => handleSort('formationTitre')}>
                                        Formation {getSortIcon('formationTitre')}
                                    </th>
                                    <th className="border-0 py-3" style={{ cursor: 'pointer' }} onClick={() => handleSort('dateDebut')}>
                                        Dates {getSortIcon('dateDebut')}
                                    </th>
                                    <th className="border-0 py-3" style={{ cursor: 'pointer' }} onClick={() => handleSort('entrepriseNom')}>
                                        Entreprise {getSortIcon('entrepriseNom')}
                                    </th>
                                    <th className="border-0 py-3" style={{ cursor: 'pointer' }} onClick={() => handleSort('participantCount')}>
                                        Participants {getSortIcon('participantCount')}
                                    </th>
                                    <th className="border-0 py-3">Lieu</th>
                                </tr>
                            </thead>
                            <tbody>
